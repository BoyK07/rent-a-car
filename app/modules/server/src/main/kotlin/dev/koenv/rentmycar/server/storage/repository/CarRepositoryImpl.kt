...
class CarRepositoryImpl {
    ...
    suspend fun create(entity: Car): Car = dbQuery {
        val insertedId = CarsTable.insert {
            ...
            it[addressLine1] = entity.addressLine1
            it[addressLine2] = entity.addressLine2
            it[postalCode] = entity.postalCode
            it[city] = entity.city
            it[country] = entity.country
            it[formattedAddress] = entity.formattedAddress
    ...
    private fun toEntity(row: ResultRow) = Car(
        ...
        addressLine1 = row[CarsTable.addressLine1],
        addressLine2 = row[CarsTable.addressLine2],
        postalCode = row[CarsTable.postalCode],
        city = row[CarsTable.city],
        country = row[CarsTable.country],
        formattedAddress = row[CarsTable.formattedAddress],
